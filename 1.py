...
while not exit:
    ...
    entry_pos=tup_r((size[0]/2-entry_size[0]/2, size[1]*17.5/18-entry_size[1]/2))
    entry_bg_size=80
    pygame.draw.rect(screen, white, tup_r((size[0]/2-entry_bg_size/2, size[1]*17.5/18-entry_bg_size/2, entry_bg_size, entry_bg_size)))
